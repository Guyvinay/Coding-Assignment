...
import com.app.service.RepoService;
...
public class RepoController {
	...
	public ResponseEntity<List<Repository>> getAllRepo(
			@PathVariable("username")String username){
		return new ResponseEntity<>(repoService.getAllRepo(username), HttpStatus.ACCEPTED);
	}
	@PostMapping(value = "/userRepos/{username}")
	public ResponseEntity<List<Repository>> saveAllRepo(
			@PathVariable("username")String username){
	...
	public ResponseEntity<Repository> getSavedRepoById(
